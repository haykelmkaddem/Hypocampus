 ...
 */
class Commentaire extends \BacklogBundle\Entity\Commentaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BacklogBundle\\Entity\\Commentaire' . "\0" . 'id', '' . "\0" . 'BacklogBundle\\Entity\\Commentaire' . "\0" . 'description', '' . "\0" . 'BacklogBundle\\Entity\\Commentaire' . "\0" . 'date_creation', '' . "\0" . 'BacklogBundle\\Entity\\Commentaire' . "\0" . 'task', '' . "\0" . 'BacklogBundle\\Entity\\Commentaire' . "\0" . 'user', '' . "\0" . 'BacklogBundle\\Entity\\Commentaire' . "\0" . 'imageFile', '' . "\0" . 'BacklogBundle\\Entity\\Commentaire' . "\0" . 'imageName', '' . "\0" . 'BacklogBundle\\Entity\\Commentaire' . "\0" . 'updatedAt'];
        }

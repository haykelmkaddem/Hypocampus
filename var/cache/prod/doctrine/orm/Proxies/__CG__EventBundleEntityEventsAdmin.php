 ...
 */
class EventsAdmin extends \EventBundle\Entity\EventsAdmin implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'EventBundle\\Entity\\EventsAdmin' . "\0" . 'idEv', '' . "\0" . 'EventBundle\\Entity\\EventsAdmin' . "\0" . 'titreEvent', '' . "\0" . 'EventBundle\\Entity\\EventsAdmin' . "\0" . 'numeroEvent', '' . "\0" . 'EventBundle\\Entity\\EventsAdmin' . "\0" . 'typeEvent'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EventsAdmin $proxy) {
    ...
    public function setNumeroEvent($numeroEvent)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setNumeroEvent', [$numeroEvent]);

        return parent::setNumeroEvent($numeroEvent);
    }
    ...
    public function getNumeroEvent()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNumeroEvent', []);

        return parent::getNumeroEvent();
    }

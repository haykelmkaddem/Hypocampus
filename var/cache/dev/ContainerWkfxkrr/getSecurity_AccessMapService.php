...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/register/confirmed'), [0 => 'IS_AUTHENTICATED_REMEMBERED'], NULL);
...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/backlog/'), [0 => 'ROLE_USER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/meeting/'), [0 => 'ROLE_USER'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/equipe/'), [0 => 'ROLE_USER'], NULL);
